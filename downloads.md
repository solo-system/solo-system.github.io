...
All the code behind the Solo project is licensed and developed openly.  If you would like to contribute, have a look at <a href="http://www.github.com/solo-system">the github site</a>, where you will find 3 repositories.  "solo" sets up the raspberry pi to host the audio recorder "amon".  Documentation (this very site) is in the other repo: <a href="http://www.github.com/solo-system/solo-system.github.io/"> here.</a>
